...
`;
    ...
    const botConfigs: Record<string, any> = {
      ...
      'bot4': {
        name: '"자동봇 4호기(수도권 청약/무순위 줍줍 전문)"',
        target: '유주택/무주택 영끌족',
        unique1: '서울/수도권 로또 아파트 무순위 청약(줍줍) 및 분양 일정 (예: 디에이치, 래미안)',
        unique2: '부동산 벼락거지 공포 및 수억 원의 시세차익 강조'
      },
      'bot5': {
        name: '"자동봇 5호기(부동산 대출 & 정책 전문)"',
        target: '내 집 마련 준비생 및 영끌족',
        unique1: '신생아 특례대출, 디딤돌, 전세자금 대출, 보금자리론 등 부동산 대출 및 정책',
        unique2: '대출 한도 축소 공포 및 "이 조건 모르면 대출 거절" 프레임'
      },
      'bot6': {
        name: '"자동봇 6호기(급매/경매/하락장 분석 전문)"',
        target: '부동산 투자자 및 무주택 대기자',
        unique1: '마피/무피 매물, 부동산 경매, 폭락장 지역 분석 (예: 동탄, 송도 폭락 사례)',
        unique2: '영끌족의 비명, 집값 폭락 공포 자극 및 "지금 안 사면 바보" 또는 "지금 사면 호구" 극단적 뷰'
      },
      'bot7': {
        name: '"자동봇 7호기(재개발/교통 호재 전문)"',
        target: '부동산 갭투자자 및 실거주 목적자',
        unique1: 'GTX, 신도시 지정, 재개발/재건축 추진 지역 등 부동산 교통 및 개발 호재',
        unique2: '호재 발표 전 선점하지 못한 기회비용과 집값 폭등 공포 자극'
      },
      'bot8': {
        name: '"자동봇 8호기(정치/좌파 스피커)"',
        target: '진보 정치/사회 관심층',
        unique1: '이재명 정부 주요 행보 및 정책 방어, 장동혁 및 국민의힘 비판, 좌파 주요 인물 열전, 2026 지방선거 지역별 여론조사 분석',
